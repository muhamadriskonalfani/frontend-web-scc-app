    ...
    var settingsObject = {
        ...
        settings: {
            layout: {
                ...
                boxed: true,
                logo: {
                    darkLogo: '/assets/src/assets/img/logo.png',
                    lightLogo: '/assets/src/assets/img/logo.png'
                }
            }
        },
        reset: false
        ...
        if (getParseObject.settings.layout.darkMode) {
            ...
            if (ifStarterKit) {
                if (document.querySelector('.navbar-logo')) {
                    document.querySelector('.navbar-logo').setAttribute('src', '/assets/src/assets/img/logo.png')
                }
            } else {
                if (document.querySelector('.navbar-logo')) {
