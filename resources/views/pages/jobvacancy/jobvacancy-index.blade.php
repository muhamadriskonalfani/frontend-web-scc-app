...
<div>
    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/jobvacancy/index') }}">Info Karir</a></li>
                <li class="breadcrumb-item active" aria-current="page">Daftar Lowongan Kerja</li>
            </ol>
        </nav>
    </div>
    <!-- /BREADCRUMB -->
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered text-center">
                            ...
                            <tbody>
                                ...
                                @forelse ($vacancies['data'] as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-btns">
                                                <a href="{{ route('jobvacancy.show', $item['id']) }}" style="cursor: pointer;" class="action-btn btn-view bs-tooltip me-2" data-toggle="tooltip" data-placement="top" title="Detail">
