...
<div>
    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/users/student') }}">Pengguna</a></li>
                        ...
                        <div class="">
                            <form method="GET" class="d-flex align-items-end gap-2">
                                ...
                                <div class="w-100">
                                    ...
                                    <input type="text" name="entry_year" class="form-control py-2" placeholder="..." value="{{ request('entry_year') }}">
                                </div>
