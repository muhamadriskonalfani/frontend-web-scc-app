...
<div>
    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/master/study-programs') }}">Master</a></li>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            <div class="d-flex justify-content-start align-items-center pt-2 pe-2">
                                ...
                                <div>
                                    <a href="{{ route('master.study-programs.create') }}" class="btn btn-primary">
                                        Tambah
                                    </a>
                                </div>
                            </div>
                        ...
                        <table class="table table-hover table-bordered text-center">
                            <thead>
                                <tr class="text-center">
                                    ...
                                    <th scope="col" class="text-start">Program Studi</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex justify-content-center">
                                            <div class="action-btns">
                                                <a href="{{ route('master.study-programs.edit', $item['id']) }}" class="action-btn btn-edit bs-tooltip me-2" data-toggle="tooltip" data-placement="top" title="Edit">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg>
                                                </a>
                                            </div>
                                            <div class="action-btns">
                                                <form method="POST" action="{{ route('master.study-programs.destroy', $item['id']) }}" 
