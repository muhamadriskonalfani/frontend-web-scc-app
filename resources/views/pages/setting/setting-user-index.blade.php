...
<div>
    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/setting/users/index') }}">Master</a></li>
                        ...
                        <div class="">
                            <form method="GET" class="d-flex align-items-end gap-2">
                                ...
                                <div class="w-100">
                                    ...
                                    <input type="text" name="entry_year" class="form-control py-2" placeholder="Tahun Masuk" value="{{ request('entry_year') }}">
                                </div>
                            ...
                            <tbody>
                                ...
                                @forelse ($users as $user)
                                    <tr>
                                        ...
                                        <td>{{ $user['tracer_study']['study_program']['name'] ?? '-' }}</td>
                                        ...
                                        <td>
                                            <span class="badge {{ $statusClasses[$user['status']] ?? 'badge-light-secondary' }}" style="width: 90px;">
                                                ...
                                                @elseif ($user['status'] == 'active') Aktif
